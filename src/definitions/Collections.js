 ...
 *  example below for /energy/harvest/periods/week/20190204T090623.555/2?site=999
 * collections[0]....
    { collection:
      { href: 'http://localhost:8080/energy/harvest/periods/week/20190204/1?site=900',
        version: '0.2',
 ...
 * collections[0].collection.links[0]....
    { rel: 'up',
      ...
      href: 'http://localhost:8080/energy/harvest/periods/month/20190201/1?site=900',
      render: 'link' 
    }
 * collections[0].collection.items[0].... 
 { href: 'http://localhost:8080/energy/harvest/periods/day/20190204/1?site=900',
   links:
   [ { rel: 'self',
       name: 'day',
       prompt: 'Mon Feb 4th',
     ...
     { rel: 'collection',
       ...
       href: 'http://localhost:8080/energy/harvest/periods/timeofday/20190204T0000/4?site=900',
       render: undefined } ],
   data:
